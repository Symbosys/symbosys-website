    ...
    <div className="space-y-6 h-full flex flex-col">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/admin/jobs"
            className="px-3 py-1.5 bg-brand text-white rounded-lg text-xs font-medium shadow-lg shadow-brand/25 hover:bg-brand-dark transition-colors flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-0">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-2">
                            <h4 className="text-sm font-semibold text-text-main dark:text-white truncate">
                              {enquiry.name}
                            </h4>
                            {!enquiry.isRead && (
                              <span
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm h-full flex flex-col">
          ...
          <div className="p-4 grid grid-cols-2 gap-3 overflow-y-auto flex-1 content-start">
            <Link
              href="/admin/jobs"
              className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl bg-gray-50 dark:bg-gray-800 hover:bg-brand/5 hover:text-brand transition-all border border-transparent hover:border-brand/20 group h-24"
            >
              <span className="material-symbols-outlined text-xl text-gray-400 group-hover:text-brand">
                post_add
              </span>
              <span className="text-[10px] font-semibold text-text-muted dark:text-gray-400 group-hover:text-brand">
                Post Job
              </span>
            </Link>
            <Link
              href="/admin/team"
              className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl bg-gray-50 dark:bg-gray-800 hover:bg-blue-500/5 hover:text-blue-500 transition-all border border-transparent hover:border-blue-500/20 group h-24"
            >
              <span className="material-symbols-outlined text-xl text-gray-400 group-hover:text-blue-500">
                person_add
              </span>
              <span className="text-[10px] font-semibold text-text-muted dark:text-gray-400 group-hover:text-blue-500">
                Add Member
              </span>
            </Link>
            <Link
              href="/admin/departments"
              className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl bg-gray-50 dark:bg-gray-800 hover:bg-purple-500/5 hover:text-purple-500 transition-all border border-transparent hover:border-purple-500/20 group h-24"
            >
              <span className="material-symbols-outlined text-xl text-gray-400 group-hover:text-purple-500">
                domain_add
              </span>
              <span className="text-[10px] font-semibold text-text-muted dark:text-gray-400 group-hover:text-purple-500">
                Add Dept
              </span>
            </Link>
            <Link
              href="/admin/enquiries"
              className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl bg-gray-50 dark:bg-gray-800 hover:bg-orange-500/5 hover:text-orange-500 transition-all border border-transparent hover:border-orange-500/20 group h-24"
            >
              <span className="material-symbols-outlined text-xl text-gray-400 group-hover:text-orange-500">
                mail
              </span>
              <span className="text-[10px] font-semibold text-text-muted dark:text-gray-400 group-hover:text-orange-500">
                Enquiries
              </span>
            </Link>
          </div>
