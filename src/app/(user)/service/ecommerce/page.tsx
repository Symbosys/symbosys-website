                ...
                <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-16">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-text-muted max-w-4xl mx-auto dark:text-gray-300">
                        ...
                        <div className="glass-card rounded-3xl p-8 md:p-12 mb-8">
                            <p className="text-lg text-text-muted dark:text-gray-300 leading-relaxed text-center">
                            ...
                            {ecommerceFeatures.map((feature, index) => (
                                <div key={index} className="group relative">
                                    ...
                                    <div className="relative glass-card rounded-2xl p-6 h-full text-center">
                                        ...
                                        <h3 className="text-lg font-bold text-text-main mb-2 dark:text-white">{feature.title}</h3>
                                        <p className="text-text-muted text-sm dark:text-gray-300">{feature.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
