import { JobInfiniteList } from "./JobInfiniteList";

// Define the Job type locally or import it (duplicating for safety/speed now)
type Job = {
    id: number;
    title: string;
    description: string;
...
export function OpenPositions({ initialJobs, initialTotalPages }: OpenPositionsProps) {
    return (
        <section id="openings" className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-32">
            <div className="glass-panel p-8 md:p-12 rounded-4xl">
                ...
                <JobInfiniteList initialJobs={initialJobs} initialTotalPages={initialTotalPages} />
