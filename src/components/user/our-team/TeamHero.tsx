    ...
    return (
        <section className="relative w-full flex flex-col items-center overflow-hidden pt-32 pb-32">
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-[5%] left-[10%] w-[50vw] h-[50vw] max-w-[650px] max-h-[650px] rounded-full bg-gradient-to-br from-brand/15 via-brand-purple/10 to-brand-blue/8 blur-3xl animate-liquid-float opacity-60 dark:opacity-40"></div>
                <div className="absolute bottom-[10%] right-[5%] w-[40vw] h-[40vw] max-w-[550px] max-h-[550px] rounded-full bg-gradient-to-tl from-brand-blue/15 via-brand/8 to-brand-purple/10 blur-3xl animate-float-delayed opacity-50 dark:opacity-35"></div>
                <div className="absolute top-[45%] right-[30%] w-[18vw] h-[18vw] max-w-[250px] max-h-[250px] rounded-full bg-gradient-to-r from-brand-purple/12 to-brand/8 blur-3xl animate-float opacity-40 dark:opacity-25"></div>
                {/* Sparkle dots */}
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-8 md:gap-14 animate-fade-in">
                        {[
                            ...
                            <div key={i} className="text-center group cursor-default">
                                <div className="text-3xl md:text-4xl font-bold bg-gradient-to-br from-brand to-brand-purple bg-clip-text text-transparent group-hover:from-brand-purple group-hover:to-brand-blue transition-all duration-500">
                                    {stat.value}
                                </div>
