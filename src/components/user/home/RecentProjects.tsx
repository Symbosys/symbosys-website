    ...
    return (
        <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-32">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                ...
                <button className="hidden md:flex group px-6 py-3 rounded-full border border-brand/20 dark:border-white/10 bg-white/50 dark:bg-gray-800/50 hover:bg-brand hover:text-white transition-all items-center gap-2 font-semibold">
                    View All Projects
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[1, 2, 3].map((item) => (
                    ...
                    >
                        ...
                        <div className="h-64 w-full bg-gray-200 dark:bg-gray-800 relative overflow-hidden">
            ...
            <div className="md:hidden mt-8 text-center">
                <button className="px-6 py-3 rounded-full border border-brand/20 dark:border-white/10 bg-white/50 dark:bg-gray-800/50 hover:bg-brand hover:text-white transition-all inline-flex items-center gap-2 font-semibold">
                    View All Projects
