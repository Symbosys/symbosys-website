        ...
        <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-32">
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
                ...
                <div className="lg:w-1/2">
                    ...
                    <button className="group h-12 px-6 rounded-full border border-brand/20 bg-brand/5 text-brand font-bold hover:bg-brand hover:text-white transition-all duration-300 flex items-center gap-2">
                        Discover More
                ...
                <div className="lg:w-1/2 flex flex-col gap-6">
                    {features.map((feature, index) => (
                        ...
                        >
                            <div className="shrink-0 size-12 rounded-xl bg-white shadow-sm flex items-center justify-center text-brand mt-1 group-hover:bg-brand group-hover:text-white transition-colors">
