                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-3xl md:text-4xl font-bold text-text-main dark:text-white mb-6 leading-tight">
                            Our elite engineering collective is committed to architecting
                            digital solutions that transcend standards and{" "}
                            <span className="text-brand">drive exponential growth.</span>
                        </h2>
                    ...
                    <div className="grid lg:grid-cols-5 gap-12">
                        <div className="lg:col-span-2">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-blue/10 border border-brand-blue/20 mb-6">
                                <span className="material-symbols-outlined text-brand-blue text-xs">
                                    auto_awesome
                                </span>
                            ...
                            <h3 className="text-2xl md:text-3xl font-bold text-text-main dark:text-white mb-4">
                                Modern Enterprise Planning
                            </h3>
                            <p className="text-text-muted dark:text-gray-400 text-lg mb-8 leading-relaxed">
                                Architect a resilient, future-ready organization with Symbosys
                                ERP ecosystems. We leverage sophisticated AI frameworks to
                                ensure your business remains agile, optimized, and ready for
                        ...
                        <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-y-4 gap-x-8">
                            {[
                                ...
                                "Real-time ERP Intelligence",
                            ].map((feature, index) => (
                                <div
                                    key={index}
                                    className="flex items-center gap-3 py-2 border-b border-brand/10 dark:border-white/10"
                                >
