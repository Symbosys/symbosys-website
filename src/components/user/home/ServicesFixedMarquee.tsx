            ...
            <div className="flex flex-col lg:flex-row items-stretch">
                ...
                <div className="lg:hidden w-full mb-4 px-4">
                    <div className="glass-panel rounded-2xl p-6 text-center shadow-sm">
                        <h2 className="text-2xl font-bold text-text-main dark:text-white">Our Services</h2>
                    </div>
                </div>

                {/* Marquee Section */}
                <div className="flex-1 overflow-hidden py-8 lg:py-12 relative group">
                    <div className="absolute left-0 top-0 bottom-0 w-24 bg-linear-to-r from-surface dark:from-gray-950 to-transparent z-10 pointer-events-none lg:hidden"></div>
                    <div className="absolute right-0 top-0 bottom-0 w-24 bg-linear-to-l from-surface dark:from-gray-950 to-transparent z-10 pointer-events-none"></div>

                    {/* UPDATED SPEED HERE */}
                    <div className="flex whitespace-nowrap animate-marquee animation-duration-[10s] lg:animation-duration-[17s] hover:paused">
                        {[...services, ...services].map((service, index) => (
                            ...
                            >
                                ...
                                <span className="text-text-main dark:text-gray-200 font-medium">{service}</span>
                            </div>
                        ))}
                    </div>
                </div>
