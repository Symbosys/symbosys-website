        ...
        <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-32">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {contactMethods.map((method, index) => (
                    ...
                    >
                        <div className="size-16 rounded-full bg-brand/5 dark:bg-brand/10 flex items-center justify-center text-brand mb-6 group-hover:bg-brand group-hover:text-white transition-colors duration-300">
                        ...
                        <p className="text-text-muted dark:text-gray-400 font-medium text-lg group-hover:text-brand transition-colors">
                            {method.value}
                        </p>
                    </a>
                ))}
            ...
            {/* Google Map */}
            <div className="w-full h-[450px] rounded-3xl overflow-hidden glass-card mt-12 group">
                <iframe
