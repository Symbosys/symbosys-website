export function OurPhilosophy() {
    const philosophies = [
        {
            label: "People First",
            value: "We put humans at the heart of everything we build — from our team relationships to the software we craft for clients.",
            icon: "volunteer_activism",
        },
        {
            label: "Quality Over Speed",
            value: "We take pride in delivering polished, robust solutions. Excellence is not an act, it is a habit embedded in our DNA.",
            icon: "diamond",
        },
        {
            label: "Grow Together",
            value: "Individual success fuels collective progress. When one of us learns, all of us grow. That is the Symbosys way.",
            icon: "forest",
        },
    ];
            ...
            <div className="relative">
                ...
                <div className="relative glass-card rounded-[2rem] p-10 lg:p-14 overflow-hidden">
                    ...
                    <div className="relative z-10 text-center space-y-8">
                        ...
                        <div className="mx-auto size-24 rounded-3xl bg-gradient-to-br from-brand/15 to-brand-purple/10 dark:from-brand/25 dark:to-brand-purple/15 flex items-center justify-center shadow-lg shadow-brand/5">
                        ...
                        <div>
                            ...
                            <p className="text-text-muted dark:text-gray-400 leading-relaxed max-w-md mx-auto">
                                Like liquid light, our culture flows through every interaction, every line of code,
                                and every relationship we nurture — luminous, adaptable, and always moving forward.
                            </p>
                        </div>
                ...
                <div className="absolute inset-0 bg-brand/[0.03] dark:bg-brand/[0.06] rounded-[2rem] -rotate-2 scale-95 -z-10 blur-sm"></div>
            </div>
            ...
            <div className="space-y-6">
                <div className="mb-8">
                    ...
                    <p className="text-text-muted dark:text-gray-400 text-lg leading-relaxed">
                        Three principles that define every decision we make and every product we deliver.
                    </p>
                </div>
                ...
                {philosophies.map((philosophy, index) => (
                    ...
                    >
                        {/* Hover gradient */}
                        <div className="absolute inset-0 bg-gradient-to-r from-brand/[0.03] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl"></div>

                        <div className="relative z-10 flex items-start gap-5">
                            <div className="shrink-0 size-12 rounded-xl bg-gradient-to-br from-brand/10 to-brand-purple/5 dark:from-brand/15 dark:to-brand-purple/10 flex items-center justify-center group-hover:from-brand group-hover:to-brand-purple transition-all duration-500 shadow-sm">
