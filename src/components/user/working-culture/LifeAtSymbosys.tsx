...
export function LifeAtSymbosys() {
    const moments = [
        ...
        },
        {
            ...
            description: "A dedicated space for experimenting with emerging technologies and building the future.",
            icon: "science",
            span: "lg:col-span-1",
            height: "min-h-[300px]",
            gradient: "from-brand-blue/20 via-brand-purple/10 to-transparent",
            // TODO: Replace with your internal image -> image: "/images/culture/innovation.jpg",
            image: null,
        },
        {
            title: "Mentorship",
            description: "Guided growth with industry veterans who are committed to your professional development.",
            icon: "supervised_user_circle",
            span: "lg:col-span-1",
            height: "min-h-[300px]",
            gradient: "from-brand/20 via-brand-blue/10 to-transparent",
            // TODO: Replace with your internal image -> image: "/images/culture/mentorship.jpg",
            image: null,
        },
        {
            title: "Community Impact",
            description: "Giving back through tech education initiatives and local community support programs.",
            icon: "volunteer_activism",
            span: "lg:col-span-1",
            height: "min-h-[300px]",
            gradient: "from-brand-purple/20 via-brand/10 to-transparent",
            // TODO: Replace with your internal image -> image: "/images/culture/community.jpg",
            image: null,
        },
        {
            title: "Remote First",
            description: "Work from where you feel most productive. We believe in output over hours and trust our team completely.",
            icon: "public",
            span: "lg:col-span-3",
            height: "min-h-[350px]",
            gradient: "from-brand-blue/20 via-brand-purple/10 to-transparent",
            // TODO: Replace with your internal image -> image: "/images/culture/remote.jpg",
            image: null,
        },
    ];
